...
public class Crypto {
	...
	public static void main(String args[]) {
		try {
			...
			// Decrypt
			encrypter.decrypt(new FileInputStream("c:/temp/Encrypted.txt"), new FileOutputStream(
	 ...
	 * Input is a string to encrypt.
	 * 
	 * @return a BASE64 string of the byte array
	 */
	...
	public String decryptBase64(String base64CipherText) {
		try {
			String plaintext = new String(dcipher.doFinal(new BASE64Decoder().decodeBuffer(base64CipherText)), "UTF-8");
			return plaintext;
		} catch (Exception e) {
			e.printStackTrace();
			return null;
